...
public class HumanoidAircraftController : MonoBehaviour
{
    ...
    {
        if (humanoidAircraftFlyingSystem.isTurnedOff)
            humanoidAircraftFlyingSystem.TurnOn();
        else
            humanoidAircraftFlyingSystem.TurnOff();

        return humanoidAircraftFlyingSystem.isTurnedOff;
    }
    ...
    {
        humanoidAircraftFlyingSystem.VerticalSlowDown();
    }
}